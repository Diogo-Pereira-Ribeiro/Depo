...
class PluginExtensionLegacy : Plugin<Project> {
    override fun apply(target: Project): Unit = with(target) {
        ...
        android {
            ...
            buildTypes {
                configureEach {
                    buildConfigField("String", "MEGACLOUD_API", "\"${project.findProperty("MEGACLOUD_API") ?: ""}\"") 
                    buildConfigField("String", "KISSKH_API", "\"${project.findProperty("KISSKH_API") ?: ""}\"") 
                    buildConfigField("String", "KISSKH_SUB_API", "\"${project.findProperty("KISSKH_SUB_API") ?: ""}\"") 
                    buildConfigField("String", "KAISVA", "\"${project.findProperty("KAISVA") ?: ""}\"") 
